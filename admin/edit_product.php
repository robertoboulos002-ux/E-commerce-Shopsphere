...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="number" id="available_quantity" value="<?php echo $row['available_quantity']; ?>" name="available_quantity" class="form-control" required="required">
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
if (isset($_POST['edit_product'])) {
    ...
    if (
        ...
        $product_category == '' or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or
...
if(isset($_POST['edit_product'])){
    ...
    $product_category=$_POST['product_category'];
    $product_brands=$_POST['product_brands'];
    $available_quantity=$_POST['available_quantity']; // Retrieve the new quantity
    $product_price=$_POST['product_price'];
    ...
    if($product_title=='' or $product_description=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price==''){
        ...
        $update_product="UPDATE `products` SET 
            ...
            available_quantity='$available_quantity',  -- Update the quantity here
            date=NOW() 
