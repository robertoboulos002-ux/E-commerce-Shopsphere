...
if($row_count==0){
    ...
    ?>
        <tr class="text-center">
            ...
            <td><a href='index.php?delete_category=<?php echo $category_id ?>' class='text-success' type="button" class="text-success" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $category_id; ?>"><i class='fa-solid fa-trash'></i></a></td>
