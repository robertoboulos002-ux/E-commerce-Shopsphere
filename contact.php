...
<body>
  ...
  <div class="container-fluid p-0">
    ...
    <!-- fourth child -->
    <div class="container">
    <h3 class="text-center text-success m-4">Need to get in touch with us? Fill out the form with your inquiry</h3>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form action="" method="POST">
            <div class="mb-3">
    <label for="username" class="form-label fw-bold">Username</label>
    <input type="text" class="form-control" id="username" name="username" value="<?php echo isset($_SESSION['username']) ? $_SESSION['username'] : ''; ?>" <?php echo isset($_SESSION['username']) ? 'readonly' : ''; ?> required>
</div>
<!--
<div class="mb-3">
    <label for="user_email" class="form-label fw-bold">Email address</label>
    <input type="email" class="form-control" id="user_email" name="user_email" required>
    Readonly attribute added to prevent user modification 
</div>-->
                <div class="mb-3">
                    <label for="message" class="form-label fw-bold">Message</label>
                    <textarea class="form-control" id="message" rows="5" name="message" required></textarea>
                </div>
                <button type="submit" class="btn btn-secondary mb-2 fw-bold" name="send_message">Send Message</button>
            </form>
        </div>
    </div>
    <?php
