...
$insert_query="insert into `user_orders` (`user_id`, `amount_due`, `invoice_number`, `total_products`, `order_date`, `order_status`) values ($user_id,$subtotal,$invoice_number,$count_product,NOW(),'$status')";
...
$result_orders_pending=mysqli_query($con,$insert_pending_orders);
